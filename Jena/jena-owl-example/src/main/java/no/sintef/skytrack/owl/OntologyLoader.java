...
public class OntologyLoader {
	...
	public static OntModel loadOntology(String source, String filePath)
	{
		...
		OntModel inf = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM_RDFS_INF, base);
	
		System.out.println("Validating the ontology");
		
		long startTime = System.currentTimeMillis();
		
		ValidityReport validateReport = inf.validate();
		
		long endTime = System.currentTimeMillis();
		
		System.out.println("Validate takes " + (endTime - startTime) + " ms");
